...
namespace ICS.Core.Host.Migrations
{
    ...
    [Migration("20200521174934_ChangeMaxNumberRfidInCredentialCard")]
    partial class ChangeMaxNumberRfidInCredentialCard
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ICS.Core.Host.Data.Entities.CredentialCard", b =>
                {
                    b.HasOne("ICS.Core.Host.Data.Entities.Client", "Client")
                        .WithOne("CredentialCard")
                        .HasForeignKey("ICS.Core.Host.Data.Entities.CredentialCard", "ClientUuid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
