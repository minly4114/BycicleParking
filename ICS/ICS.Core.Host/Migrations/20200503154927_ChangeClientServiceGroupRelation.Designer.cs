...
namespace ICS.Core.Host.Migrations
{
    ...
    [Migration("20200503154927_ChangeClientServiceGroupRelation")]
    partial class ChangeClientServiceGroupRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ICS.Core.Host.Data.Entities.SessionParking", b =>
                {
                    ...
                    b.Property<int?>("KeepAliveEndSessionId")
                        .HasColumnType("integer");

                    b.Property<int?>("KeepAliveOpenSessionId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("KeepAliveEndSessionId");

                    b.HasIndex("KeepAliveOpenSessionId");
            ...
            modelBuilder.Entity("ICS.Core.Host.Data.Entities.SessionParking", b =>
                {
                    b.HasOne("ICS.Core.Host.Data.Entities.ParkingPlaceKeepAlive", "KeepAliveEndSession")
                        .WithMany()
                        .HasForeignKey("KeepAliveEndSessionId");

                    b.HasOne("ICS.Core.Host.Data.Entities.ParkingPlaceKeepAlive", "KeepAliveOpenSession")
                        .WithMany()
                        .HasForeignKey("KeepAliveOpenSessionId");
