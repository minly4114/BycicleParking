...
namespace ICS.Core.Host.Migrations
{
    ...
    [Migration("20200612115240_AddMessaging")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ICS.Core.Host.Data.Dialog", b =>
                {
            ...
            modelBuilder.Entity("ICS.Core.Host.Data.Entities.Message", b =>
                {
                    b.HasOne("ICS.Core.Host.Data.Dialog", "Dialog")
                        .WithMany("Messages")
                        .HasForeignKey("DialogUuid");

                    b.HasOne("ICS.Core.Host.Data.Entities.Participant", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientUuid");
            ...
            modelBuilder.Entity("ICS.Core.Host.Data.Entities.Participant", b =>
                {
                    b.HasOne("ICS.Core.Host.Data.Dialog", null)
